    ...
    extends Message
{
    ...
    public final static MessageDetails<ByteMultiArray> DETAILS = new MessageDetails<ByteMultiArray>(Name.parseMessageName("std_msgs/ByteMultiArray"), "70ea476cbcfd65ac2f68f3cda1e891fe", "ByteMultiArray message", (ByteMultiArray.class));
    /**
