    ...
    extends Message
{
    ...
    public final static MessageDetails<UInt8MultiArray> DETAILS = new MessageDetails<UInt8MultiArray>(Name.parseMessageName("std_msgs/UInt8MultiArray"), "82373f1612381bb6ee473b5cd6f5d89c", "UInt8MultiArray message", (UInt8MultiArray.class));
    /**
